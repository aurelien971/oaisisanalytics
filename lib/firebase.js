...
const PRODUCTS = {
  ...
  surrender:  { env: "SURRENDER_SERVICE_ACCOUNT_B64",  file: "serviceAccount.surrender.json" },
  complainr:  { env: "COMPLAINR_SERVICE_ACCOUNT_B64",  file: "serviceAccount.complainr.json" },
  hineni:     { env: "HINENI_SERVICE_ACCOUNT_B64",     file: "serviceAccount.hineni.json" },
};
